...
<body>
	<div   id="app" class="mind-con">
		<div>
			<span>选择签标</span>
			<select  id="aaa" class="iview_select"  @change="changeURL1($event,this)" >
...
<script src="/js/jquery/3.3.1/jquery.min.js"></script>
	...
	var app = new Vue({
	    ...
	    methods: {
	        ...
	        initgraph(){
	            ...
	            var height =715;// window.screen.height - 154;//
	        ...
	        updategraph() {
	           ...
	           if(links.length>0){
	            ...
	            _this.svg.selectAll(".action_1").on("click", function (d) {
	                _this.nodebuttonAction='SELECT';
	            });
	            _this.svg.selectAll(".action_2").on("click", function (d) {
					_this.nodebuttonAction='DTL';
	...
	function changeURL1(e,thisObj) {
		...
		//alert(href);
		//alert(href);
		var newHref="/NEO/demo/"+optionDom.value;
		//console.log(newHref);
