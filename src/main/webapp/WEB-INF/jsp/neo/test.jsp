...
<div class="header" style="height: 100px;width: auto" >

</div>

<div class="topnav" style="align-items: center;">
    <input class="my_input" style="margin-top: 10px"></input>
</div>
<div style="background:url(/static/img/background1.png);" id="app">

   <%-- <div &lt;%&ndash;class="column" &ndash;%&gt;style="width:50%;background:url(/static/img/background1.png) ;">
        <div>
            <div id="main" style="height: 100px;/*width: 600px;height:400px;*/display: inline-block;margin-left: 5px;"></div>
        </div>
&lt;%&ndash;        <div id="main1" style="height: 250px;/*width: 700px;height:400px;*/display: inline-block;margin-left: 5px"></div>&ndash;%&gt;
    </div>--%>
    <div <%--class="column" --%>style="width:500px;display: inline-block">
        <div>
            <div class="border-box" style="width: 100%;height:250%;margin-bottom: 20px;margin-left: 10px">
                <div id="main" style="width: 90%;height:250%;display: inline-block;margin-left: 20px;margin-right: 20px"></div>
            </div>
            <div id="main1" style="width:90%;height:280px;display: inline-block;margin-left: 20px;margin-right: 20px" ></div>
        </div>
    </div>
    <div <%--class="column" --%>style="width: 1000px;display: inline-block">
<%--        <div class="border-box">--%>
            <div id="graphcontainer"  class="graphcontainer" <%--style="display: inline-block;vertical-align: middle"--%> >
            </div>
<%--        </div>--%>

    </div>
</div>
<%--<div id="app" &lt;%&ndash;class="layout"&ndash;%&gt;>
    <div class="layout">
        ...
        <div class="layout-content">
            <Row>
                <i-col span="4">
                    <i-menu theme="dark" active-name="1"  width="auto" &lt;%&ndash;style="margin-top: 10px"&ndash;%&gt;>
                        <Menu-group title="">
                ...
                <i-col span="20">
                    <div class="layout-content-main" style="margin-top: 5px;margin-left: 5px">
                        <div id="graphcontainer"  class="graphcontainer" &lt;%&ndash;style="display: inline-block;vertical-align: middle"&ndash;%&gt; ></div>
                    </div>
                </i-col>
            </Row>
        </div>
        ...
        <Divider> </Divider>
        <div>
            <div id="main" style="width: 600px;height:400px;display: inline-block;margin-left: 5px;"></div>
            <div id="main1" style="width: 700px;height:400px;display: inline-block;float:right"></div>
        </div>
    </div>
</div>--%>
